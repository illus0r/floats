...
function init() {
  ...
  var draw = SVG('drawing').size(500, 500); //var rect = draw.rect(400, 400).attr({ fill: '#f06' })
  ...
  partsAvailable = [[256, 256, 120], [256, 256, 120], [16, 16, 40], [16, 256, 100], [256, 16, 40], [16, 16, 40], [16, 256, 100], [256, 16, 40]]; // Set function onTextChange() to run on every text change. And run it for the first time.
